...
QGroupBox#calibrationGroup{border:1px solid #2aa9b8;color:#6fe7f3;background:#0e1b1e;}QGroupBox#calibrationGroup::title{color:#6fe7f3;font-weight:800;}QLabel#calibrationFieldLabel{color:#9beef5;font-weight:700;}QLineEdit#calibrationParameterField{background:#12343a;border:1px solid #42c7d5;color:#eaffff;font-weight:700;}QLineEdit#calibrationParameterField:focus{border:2px solid #6fe7f3;background:#164047;}QLineEdit#calibrationReadonlyField{background:#15272a;border:1px solid #397880;color:#8dcbd1;}
